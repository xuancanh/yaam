...
export function freshSettingsSlice(): SettingsSlice {
  return {
    agentTypes: [
      ...
      { id: 'opencode', name: 'OpenCode', color: '#7FD1FF', model: 'opencode', tools: 6, desc: 'Open-source terminal agent — bring your own models.', enabled: false, resumeCmd: 'opencode --session {id}', resumeFallbackCmd: 'opencode --continue', probe: 'opencode' },
