// The Master conversation body — message stream, tool approvals, composer —
// shared by the docked Sidebar and the Mission Control view, so the user
// always talks to ONE chat no matter which surface hosts it.
...
export function MasterChat() {
  ...
  // every mount (sidebar re-open, view switch) starts at the latest message
  useEffect(() => {
