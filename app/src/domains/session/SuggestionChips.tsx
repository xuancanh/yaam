...
// The monitor's proposed next actions for a session, as one-click chips under
// the pane header. Clicking sends the action's text straight to the session
...
export function SuggestionChips({ agent }: { agent: Agent }) {
  ...
  return (
    <div style={{
      ...
      background: 'rgba(245,196,81,.05)', borderBottom: '1px solid var(--line)', overflowX: 'auto',
    }}>
